namespace LevelImposter
{
    partial class LevelImposter
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.mapApplier = new MapApplier();
            this.mapLoader = new MapLoader();
            this.mapReverter = new MapReverter();
            ...
            this.applyButton.Click += new System.EventHandler(mapApplier.Apply);
            this.mapLoader.applyButton = this.applyButton;
            // 
            // revertButton
            // 
            ...
            this.revertButton.Click += new System.EventHandler(mapReverter.Revert);
            // 
            // progressBar
            // 
            ...
            this.mapApplier.progressBar = this.progressBar;
            this.mapLoader.progressBar = this.progressBar;
            this.mapReverter.progressBar = this.progressBar;
            // 
            // logo
            // 
            ...
            this.browseButton.Click += new System.EventHandler(mapLoader.Browse);
            // 
            // mapLabel
            // 
            ...
            this.mapLoader.mapLabel = this.mapLabel;
            // 
            // LevelImposter
            // 
        ...
        private System.Windows.Forms.Label logoBeta;
        private System.Windows.Forms.Button browseButton;
        private System.Windows.Forms.Label mapLabel;
        private System.Windows.Forms.OpenFileDialog browseDialog;
        private System.Windows.Forms.OpenFileDialog gameDirDialog;

        private MapLoader mapLoader;
        private MapApplier mapApplier;
        private MapReverter mapReverter;
    }
}
